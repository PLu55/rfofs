# Installs rfofs (JACK server binary), rfofs-client (C-ABI shared library),
# and its C header together. PREFIX defaults to /usr/local, matching the
...
install:
	@test -f $(BIN_PATH) && test -f $(LIB_PATH) || { \
